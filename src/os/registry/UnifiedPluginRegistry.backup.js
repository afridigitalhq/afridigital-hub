export const UnifiedPluginRegistry = [
  ...
  { id: "governance", label: "Governance Cockpit", icon: "🧠", cluster: "core", route: "/admin/governance" },
  { id: "kernel", label: "Kernel Contract", icon: "📡", cluster: "core", route: "/admin/kernel" }


  { id: "kernel_stream", label: "Kernel Stream", icon: "📡", cluster: "core", route: "/admin/kernel-stream" }
